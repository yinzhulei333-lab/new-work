...
A chair is a chair. You sit on it, it supports you — that is it. A lamp is a lamp. You press a switch, it turns on and off. It does not remember whether you prefer warm or cool light. It does not dim itself when you stay up late. It does not ask how your day went.

Of course, it does not need to do any of that. But it made me wonder: can design go beyond just making things?

What I am truly interested in is this: when an object does not just exist but responds to you — what happens to its value?
...
Traditional trainers are just plastic tubes. You blow into them and watch a ball rise. They are boring, give no feedback, and almost no one sticks with them.

We are turning it into a game: a steady deep breath makes the character fly upward; a short sharp exhale makes it jump. The device warms up and vibrates — like holding a cup of tea, like a heartbeat. The game can be projected onto a TV, turning solitary therapy into a living-room adventure.
...
I am here because I want to be a designer who can write code. Someone who can take an idea from a sketch to a working prototype, without having to wait for an engineer to build it for me. I want to master interaction as a tool, just as I once mastered wood and metal.

This course is a starting point for me. I do not need to become a technical expert. But I need to be competent enough to make ideas like WindSinger real — to write my own code, tweak my own parameters, change my own logic, instead of pointing fingers next to an engineer.
